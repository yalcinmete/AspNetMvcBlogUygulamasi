...
namespace AspNetMvcBlogUygulamasi.Controllers
{
    public class BlogController : Controller
    {
        ...
        public ActionResult Edit([Bind(Include = "Id,Baslik,Aciklama,Resim,Icerik,Onay,Anasayfa,CategoryId")] Blog blog)
        {
            if (ModelState.IsValid)
            {
                //db.Entry(blog).State = EntityState.Modified; //Sadece istediğim alanları güncellesin diye aşağıdaki işlemleri yaptık
                ...
                if (entity!=null)
                {
                    ...
                    //viewbag ile taşıyamıyoruz.RedirecttoAction var.
